...
export function WhatsAppSupportButton() {
  return (
    <a
      ...
      className="fixed right-4 bottom-[calc(120px+env(safe-area-inset-bottom))] z-40 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg ring-4 ring-background transition-transform hover:scale-105 md:right-6 md:bottom-16 md:h-14 md:w-14"
    >

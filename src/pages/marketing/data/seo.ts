...
export const routeSeo: Record<string, RouteSeo> = {
  ...
  "/terms": {
    ...
    description:
      "The terms and conditions governing your use of the FlockText bulk SMS platform.",
    url: `${SITE_URL}/terms`,
    image: `${SITE_URL}/og/og-home.png`,
    imageWidth: 1734,
    imageHeight: 907,
  ...
  "/privacy": {
    ...
    description:
      "How FlockText collects, uses, and protects your information and the contact data you upload.",
  ...
  "/support": {
    ...
    description:
      "Get help with your FlockText account, messages, and billing — contact us by email, phone, or WhatsApp.",
  ...
  "/churches": {
    title: "FlockText | Bulk SMS for Churches in Ghana",
    description:
  ...
  routeSeo[`/blog/${post.slug}`] = {
    ...
    jsonLd: {
      ...
      publisher: {
        ...
        logo: {
          "@type": "ImageObject",
          url: `${SITE_URL}/logo/flocktext-logo.png`,
        },
      },
    },
  };
